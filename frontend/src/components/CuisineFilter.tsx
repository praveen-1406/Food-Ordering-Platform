...
const CuisineFilter = ({ onChange, isExpanded, onExpandedClick, selectedCuisines }: Props) => {
    ...
    return (
        <>
            <div className="flex justify-between items-center px-2">
                ...
                <div onClick={handleCuisinesReset} className="text-base font-semibold mb-2 underline cursor-pointer text-blue-500">
                    Reset Filters
                </div>
            </div>
